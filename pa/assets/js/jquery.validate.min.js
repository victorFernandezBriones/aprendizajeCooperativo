...
!function (a) {
    ...
    a.extend(a.fn, {validate: function (b) {
        ...
        }, messages: {required: "Complete este campo", remote: "Please fix this field.", email: "Por favor, ingrese un E-mail válido.", url: "Por favor, ingrese una url válida.", date: "Por favor, ingrese una fecha válida.", dateISO: "Please enter a valid date ( ISO ).", number: "Por favor, ingrese números", digits: "Por favor, ingrese dígitos solamente.", equalTo: "Error, los valores no coinciden.", maxlength: a.validator.format("Please enter no more than {0} characters."), minlength: a.validator.format("Please enter at least {0} characters."), rangelength: a.validator.format("Please enter a value between {0} and {1} characters long."), range: a.validator.format("Please enter a value between {0} and {1}."), max: a.validator.format("Please enter a value less than or equal to {0}."), min: a.validator.format("Please enter a value greater than or equal to {0}."), step: a.validator.format("Please enter a multiple of {0}.")}, autoCreateRanges: !1, prototype: {init: function () {
                function b(b) {
